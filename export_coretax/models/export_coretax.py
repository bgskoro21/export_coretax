...
class ExportCoretaxInvoiceLine(models.TransientModel):
    ...
    amount_dpp     = fields.Monetary(related='invoice_id.amount_dpp', string='AMOUNT DPP', currency_field='currency_id', readonly=True)
    amount_untaxed = fields.Monetary(related='invoice_id.amount_untaxed', string='AMOUNT UNTAXED', currency_field='currency_id', readonly=True)
    amount_tax     = fields.Monetary(related='invoice_id.amount_tax', string='PPN', currency_field='currency_id', readonly=True)
    amount_total   = fields.Monetary(related='invoice_id.amount_total', string='Total', currency_field='currency_id', readonly=True)
